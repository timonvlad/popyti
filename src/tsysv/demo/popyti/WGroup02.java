...
public class WGroup02 extends Activity {
		...
		im11.setOnClickListener(new View.OnClickListener() {
	        ...
	        //        startActivity(ii);
				//Toast.makeText(getApplicationContext(), "First", Toast.LENGTH_LONG).show();
				 Intent ii = new Intent(getApplicationContext(), WGroup03.class);
	               startActivity(ii);
