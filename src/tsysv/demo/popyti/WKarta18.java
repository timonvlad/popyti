...
public class WKarta18 extends Activity {
		...
		im11.setOnClickListener(new View.OnClickListener() {
	        ...
	        //        startActivity(ii);
				//Toast.makeText(getApplicationContext(), "First", Toast.LENGTH_LONG).show();
				 Intent ii = new Intent(getApplicationContext(), WKarta19.class);
	               startActivity(ii);
