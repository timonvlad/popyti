...
public class WKarta17 extends Activity {
		...
		im11.setOnClickListener(new View.OnClickListener() {
	        ...
	        //        startActivity(ii);
				//Toast.makeText(getApplicationContext(), "First", Toast.LENGTH_LONG).show();
				 Intent ii = new Intent(getApplicationContext(), WKarta18.class);
	               startActivity(ii);
