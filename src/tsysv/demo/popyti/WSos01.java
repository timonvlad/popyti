...
public class WSos01 extends Activity {
		...
		im11.setOnClickListener(new View.OnClickListener() {
	        ...
	        //        startActivity(ii);
				//Toast.makeText(getApplicationContext(), "First", Toast.LENGTH_LONG).show();
				 Intent ii = new Intent(getApplicationContext(), WSos02.class);
	               startActivity(ii);
