...
public class Karta01 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.karta01);
		
	//	RelativeLayout ll = (RelativeLayout) findViewById(R.id.f02);
	//	ll.setBackgroundResource(R.drawable.f02);
		
		im11 = (ImageView) findViewById(R.id.karta010);
		im12 = (ImageView) findViewById(R.id.karta011);
		...
		im12.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 Intent ii = new Intent(getApplicationContext(), Karta020.class);
	                startActivity(ii);
				Log.v("KArTa01", " 2 button");
				finish();
			}
		});
